 ...
 */
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor>, AdapterView.OnItemSelectedListener {
...
//                Intent intent = new Intent(Login.this,Customer_selecting.class);
...
//        });
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                startActivity(new Intent(Login.this,MashawerMenu.class));
                finish();
            } else {
